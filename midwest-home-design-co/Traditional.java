...
public class Traditional extends House {
   ...
   private final static double DEFAULT_BASIC_RATE = 3300, DEFAULT_TOTAL_AREA = 2200;
   ...
   // re-implement method so that it uses the default values of Traditional
   @Override
   protected double calcTotalCost() {
      ...
      if (this.getTotalArea() >= 3000) {
         ...
         System.out.println("basic rate is now " + templateBasicRate);
      }
